...
#ifndef MY_WIRE_COMPONENT
#define MY_WIRE_COMPONENT
...
namespace MultipleCopies
{
    ...
    //
    class WireComponent : public SST::Component
    {
        ...
        public:
            ...
            WireComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                WireComponent,                       // Class name
                "wire",                              // Library name (the *.so)
                "WireComponent",                     // Name used to reference the component.  This can be
