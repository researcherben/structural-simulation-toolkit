...
ServerComponent::ServerComponent(SST::ComponentId_t id, SST::Params &params) :
    SST::Component(id),
    componentId_(id),
    clockTickCount_(0)
{
    ...
    registerClock(clock,
        new SST::Clock::Handler<ServerComponent>(this, &ServerComponent::clockTick));
...
//
void ServerComponent::setup(void)
{
...
//
void ServerComponent::finish(void)
{
...
// Clock event handler.
//
bool ServerComponent::clockTick(SST::Cycle_t cycle)
{
