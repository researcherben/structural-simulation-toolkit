...
#ifndef MY_SERVER_COMPONENT
#define MY_SERVER_COMPONENT
...
namespace MultipleCopies
{
    ...
    //
    class ServerComponent : public SST::Component
    {
        ...
        public:
            ...
            ServerComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                ServerComponent,                       // Class name
                "server",                              // Library name (the *.so)
                "ServerComponent",                     // Name used to reference the component.  This can be
