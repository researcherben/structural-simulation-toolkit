...
#ifndef MY_SWITCH_COMPONENT
#define MY_SWITCH_COMPONENT
...
namespace MultipleCopies
{
    ...
    //
    class SwitchComponent : public SST::Component
    {
        ...
        public:
            ...
            SwitchComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                SwitchComponent,                       // Class name
                "switch",                              // Library name (the *.so)
                "SwitchComponent",                     // Name used to reference the component.  This can be
