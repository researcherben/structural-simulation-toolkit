...
RoadComponent::RoadComponent(SST::ComponentId_t id, SST::Params &params) :
    SST::Component(id),
    componentId_(id),
    clockTickCount_(0)
{
    ...
    registerClock(clock,
        new SST::Clock::Handler<RoadComponent>(this, &RoadComponent::clockTick));
...
//
void RoadComponent::finish(void)
{
...
// Clock event handler.
//
bool RoadComponent::clockTick(SST::Cycle_t cycle)
{
