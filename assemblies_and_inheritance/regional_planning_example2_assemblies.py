...
neighborhood_2 = rplib.MyNeighborhood(prefix="n2_",
             neighborhood_lat=252, neighborhood_long=53522,
             neighborhood_width=242, neighborhood_length=23,
             link_delay="1ns",
             number_of_houses=3,
...
neighborhood_3 = rplib.MyNeighborhood(prefix="n3_",
             neighborhood_lat=252, neighborhood_long=53522,
             neighborhood_width=242, neighborhood_length=23,
             link_delay="1ns",
             number_of_houses=3,
