...
#ifndef MY_GROCERY_COMPONENT
#define MY_GROCERY_COMPONENT
...
namespace BuildingsAndRoads
{
    ...
    //
    class GroceryComponent : public SST::Component, public Building, public Weather
    {
        ...
        public:
            ...
            GroceryComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                GroceryComponent,                       // Class name
                "grocery",                              // Library name (the *.so)
                "GroceryComponent",                     // Name used to reference the component.  This can be
