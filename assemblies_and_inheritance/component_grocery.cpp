...
GroceryComponent::GroceryComponent(SST::ComponentId_t id, SST::Params &params) :
    SST::Component(id),
    componentId_(id),
    clockTickCount_(0)
{
    ...
    registerClock(clock,
        new SST::Clock::Handler<GroceryComponent>(this, &GroceryComponent::clockTick));
...
//
void GroceryComponent::setup(void)
{
...
//
void GroceryComponent::finish(void)
{
...
// Clock event handler.
//
bool GroceryComponent::clockTick(SST::Cycle_t cycle)
{
