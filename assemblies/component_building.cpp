...
BuildingComponent::BuildingComponent(SST::ComponentId_t id, SST::Params &params) :
    SST::Component(id),
    componentId_(id),
    clockTickCount_(0)
{
    ...
    registerClock(clock,
        new SST::Clock::Handler<BuildingComponent>(this, &BuildingComponent::clockTick));
...
//
void BuildingComponent::setup(void)
{
...
//
void BuildingComponent::finish(void)
{
...
// Clock event handler.
//
bool BuildingComponent::clockTick(SST::Cycle_t cycle)
{
