...
#ifndef MY_BUILDING_COMPONENT
#define MY_BUILDING_COMPONENT
...
namespace BuildingsAndRoads
{
    ...
    //
    class BuildingComponent : public SST::Component
    {
        ...
        public:
            ...
            BuildingComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                BuildingComponent,                       // Class name
                "building",                              // Library name (the *.so)
                "BuildingComponent",                     // Name used to reference the component.  This can be
